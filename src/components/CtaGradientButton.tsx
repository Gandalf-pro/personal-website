...
const CtaGradientButton = ({ href, children }: CtaGradientButtonProps) => {
  return (
    <Link
      href={href}
      className="group relative mt-3 inline-flex w-full items-center justify-center gap-2 overflow-hidden rounded-lg border border-pink-600 px-4 py-1 text-lg transition-all hover:shadow-sm hover:shadow-pink-600"
    >
